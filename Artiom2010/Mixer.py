...
pygame.mixer.music.load("musictest2.ogg")
pygame.mixer.music.load("musictest3.ogg")
pygame.mixer.music.load("musictest4.ogg")
pygame.mixer.music.queue("musictest1.ogg")
